    ...
    <div className="max-w-7xl mx-auto px-6 py-10">
      <div className="mb-10 p-10 bg-gradient-to-br from-[#008272] to-[#005a4e] rounded-md text-white shadow-lg relative overflow-hidden">
        <div className="relative z-10 max-w-2xl">
           <h1 className="text-4xl font-black mb-2 tracking-tight">Welcome to Form</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8">
        {forms.map(form => (
          <div key={form.id} className="bg-white rounded shadow-sm hover:shadow-xl transition-all border border-[#edebe9] group cursor-pointer overflow-hidden flex flex-col h-[300px] relative">
            ...
            <div className="p-6 flex-1 flex flex-col relative" onClick={() => onSelect(form.id)}>
              ...
              <h3 className="font-bold text-lg text-[#323130] line-clamp-3 mb-2 leading-tight group-hover:text-[#008272] transition-colors">{form.title}</h3>
